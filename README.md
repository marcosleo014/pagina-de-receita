...
* Controle de **cores, fontes e espaçamentos**
* Organização visual utilizando conceitos iniciais de **layout e box model**

Este projeto representa um passo importante no meu aprendizado em desenvolvimento web, servindo como base para projetos mais avançados que virão ao longo da minha jornada no curso.
